...
**Career arc:**
- Community Director, HSL Asset Management (2013)
- Yardi SQL Developer / Product Manager, Colony American Homes (2013–2015)
...
**Languages:** Assyrian (professional working) · English (native)
...
**LinkedIn:** [linkedin.com/in/johnathan-sorisho-a2110052](https://www.linkedin.com/in/johnathan-sorisho-a2110052/)
...
- Pairs with Jonathan as the founder/engineer duo — the "Steve Jobs / Steve Wozniak" archetype, where each amplifies the other
...
### Tim Elias — Co-founder

**Role at Real Tech:** Co-founder, Crypto / Legal / LATAM lane.

**What he brings:**
- Deep crypto industry network — partner pipeline for DealPayment.com
- Legal connections, including counsel who can review the team's NDA, IP filings, and patent prosecution work
- El Salvador and broader Latin America business relationships — opens DealPayment's Phase 3 (real estate parcels) and Rehabit's transactional side
- Track record running businesses; relationships across multiple verticals

**LinkedIn:** *to be added during revision pass*

*Bio detail to fill during your revision pass: career arc, named projects, education.*
...
**LinkedIn:** *slug to be added during revision pass*
...
**Education:** BS Business Management, Grand Canyon University

**What he brings to Real Tech:**
- Product strategy depth from a public NYSE company in the exact category we're targeting (Channel Partner Portal, Rovian-adjacent service workflows)
- Thought leadership voice in proptech (CES keynotes, industry interviews)
- Pairs with Wil and Jonathan to form a complete product / solutions / market-facing leadership trio

**LinkedIn:** [linkedin.com/in/braedenscheer](https://www.linkedin.com/in/braedenscheer)
...
**Prior experience:**
- Carrier (~6 years): Global Product Manager for BluEdge Digital (HVAC connected services), Program Manager for IoT Analytics Platforms, Technical Project Manager for Smart Buildings

**Education:** BS Management Information Systems, Worcester Polytechnic Institute

**LinkedIn tagline:** *"Product Leader @ SMRT | Transforming +850K Multifamily Homes"*

**What he brings to Real Tech:**
- 13+ years product leadership across IoT, smart buildings, multifamily
- Direct product responsibility over 850k+ multifamily homes
- Deep technical product chops (MIS background; Carrier IoT analytics) — bridges Halim's engineering and Braeden's strategy
- Worcester Polytechnic engineering pedigree

**LinkedIn:** [linkedin.com/in/wilmanngomez](https://www.linkedin.com/in/wilmanngomez)
...
## Items to Fill During Your Revision Pass

- Tim Elias's LinkedIn URL + 1-paragraph career arc
- Halim Khaldi's career arc, education, signature prior projects
- Justin Lesko's LinkedIn slug (his profile is gated behind LinkedIn login)
- Photo URLs for each cofounder (1080px square, professional headshot — drop into `assets/team/`)
- Any updates to Jonathan's role (e.g., "VP Solutions, since [date]" if you want the promotion date on the deck)
